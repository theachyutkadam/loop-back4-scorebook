...
export class TeamMatchController {
  ...
  async find(
    ...
    return this.teamRepository.team2Matches(id).find(filter);
  }
  ...
  async create(
    ...
    return this.teamRepository.team2Matches(id).create(match);
  }
  ...
  async patch(
    ...
    return this.teamRepository.team2Matches(id).patch(match, where);
  }
  ...
  async delete(
    ...
    return this.teamRepository.team2Matches(id).delete(where);
  }
}
